...
<nav class="navbar navbar-default navbar-fixed-top navbar-inverse  navbar-embossed"" name="top">
  <div class="container">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="/CVHammer/index.jsp">CVHammer</a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
		...
		<li ><a href="/CVHammer/expSub/userLab.jsp">个人实验站</a></li>
		  ...
		  <div class="form-group" >
			...
			<div class="btn-group" role="group" >
				  ...
				  <button type="button" class="btn btn-default glyphicon glyphicon-trash" onclick="javascript:clearArea()" ></button>
				   ...
				   <!--尺寸-->
				        <div>当前：<span id="selectName">笔</span> 尺寸<select id="selWidth">
  ...
  <!--底部设计结束-->
	...
	/*验证用户是否存在*/
	  ...
	  out.println("$('#userBtn a').text("+(String)session.getAttribute("UserPN")+");");
		...
		out.println("if(location.hash=='#Login'){$('#loginModal').modal('show');}else{$('#noticeModal').modal('show')}");
	}%>
	/*---------------画板有关-------------------*/
	// With JQuery
	$('#InputData').slider({
	...
	var myCanvasHeigt=document.documentElement.clientHeight;
    ...
    $("#chooseSketch").click(function()
    {
		...
		//console.log("clentXY"+canvasX+canvasY);
		 document.getElementById('myCanvas').width= myCanvasWidth;
		document.getElementById('myCanvas').height=myCanvasHeigt-20 ;
		...
		function log(msg){									
			...
			//console.log("颜色:"+board.strokeStyle);
			 $("#positionX").text(msg);
