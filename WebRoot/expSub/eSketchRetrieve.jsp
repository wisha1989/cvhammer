...
<div class="row">
  ...
  <!--标题-->
     <h2 class="experiment_title">草图检索</h2>
	 <p > <span class="label label-default">手绘</span>&nbsp <span class="label label-default">检索</span></p>
...
<!--实验区域结束-->
 <!--简介-->
    ...
    <p>检索算法在Tu-Berlin上建立草图数据上，建立基于Googlnet的识别模型；</p>
	</details><!--简介结束-->
      <hr/> 
	 <!--参考文献-->
 	<details close>
...
<%--注销登录--%>
 ...
 $("#upParamBtn").click( function (){
	...
	ChangeUpParamBtnInfo("DoingExp");
	  htmlobj=$.ajax({url:"../DoESketchRetrieve",
		  type: 'POST',
