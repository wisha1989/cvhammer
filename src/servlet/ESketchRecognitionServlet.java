...
public class ESketchRecognitionServlet extends HttpServlet {
	/**
	 * 
	 */
	private static final long serialVersionUID = -697391299583746803L;
	 ...
	 */
	public ESketchRecognitionServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		params.put("method", "classification");
		...
		uitem.seteName("SketchRecognition");
		...
		logger.info("call sketch recognition param :\t" + params);
		re = SingletonImgProcessor.sketch_process(bytes, params);
		logger.info("sketch recognition return :\t" + re);

		String desImgUser = re.get("class_name");
		String srcImgUser = re.get("src_image");
		uitem.seteRessType("label");
